...
import zanshin.dsl.DslStandaloneSetup;
...
public class Main {
  public static void main(final String[] args) {
    ...
    final Injector injector = _dslStandaloneSetup.createInjectorAndDoEMFRegistration();
  ...
  protected void runGenerator(final String string) {
    ...
    URI _createFileURI = URI.createFileURI(string);
    final Resource resource = set.getResource(_createFileURI, true);
